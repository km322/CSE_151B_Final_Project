...
$+36\%$/$+37\%$ relative from the milestone. The LoRA adapter
...
Two engineering issues stalled training.
...
The final submission scored 0.699 on the public board (rank 42/105)
and 0.627 on the private board (rank 27/105), $+0.184$/$+0.168$
absolute and $+36\%$/$+37\%$ relative from the milestone. Rank
went from 42 (public) to 27 (private), a +15-place jump --- we
did not overfit \texttt{private.jsonl}. The sampling sweep was the biggest
